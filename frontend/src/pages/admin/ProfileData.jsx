          ...
          <div>
            <input
              ...
              {...register("profession", {
                ...
                minLength: {
                  value: 100,
                  message: "Profession must be at least 100 characters long",
                },
              })}
            />
            {errors.profession && (
          ...
          <div>
            <textarea
              ...
              {...register("about", {
                ...
                minLength: {
                  value: 1000,
                  message: "Profession must be at least 1000 characters long",
                },
              })}
            ></textarea>
            {errors.about && (
      ...
      <div className="w-full max-w-2xl bg-white shadow-2xl rounded-2xl p-8 mt-10">
        ...
        {profileData ? (
          <div className="space-y-4">
            <p>
              {" "}
              <strong>Name:</strong> {profileData.adminName}
            </p>
            <p>
              {" "}
            ...
            <button
              type="submit"
              className="p-3 mt-5 rounded-lg text-center bg-blue-500"
              onClick={() => {
                handelEdit(profileData);
              }}
            >
              Edit
            </button>
